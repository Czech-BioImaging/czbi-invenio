...
class BiosetPermissionPolicyMixin(ModelMixin):
    """Custom permission policy for bioset."""
...
bioset_model = model(
    ...
    customizations=[
        ...
        PrependMixin("PermissionPolicy", BiosetPermissionPolicyMixin), 
