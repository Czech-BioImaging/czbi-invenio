...
class TestequipmentPermissionPolicyMixin(ModelMixin):
    """Custom permission policy for testequipment."""
...
testequipment_model = model(
    ...
    customizations=[
        ...
        PrependMixin("PermissionPolicy", TestequipmentPermissionPolicyMixin), 
    ...
    configuration={
        "ui_blueprint_name": "testequipment_ui"
    }
)
