...
class BiosetUIResourceConfig(RecordsUIResourceConfig):
    template_folder = "templates"
    url_prefix = "/bioset"
    blueprint_name = "bioset_ui"
    model_name = "bioset"

    search_component = UIComponent(
        "BiosetResultsListItem",
        "@js/bioset/search/ResultsListItem",
    ...
    application_id = "bioset"


class BiosetUIResource(RecordsUIResource):
    pass

def ui_overrides(app):
    """Register UI overrides."""
    ui_resource_config = BiosetUIResourceConfig()
...
def init_menu(app):
    ...
    with app.app_context():
        current_menu.submenu("plus.create_bioset").register(
...
def create_blueprint(app):
    ...
    blueprint = BiosetUIResource(BiosetUIResourceConfig()).as_blueprint()
    return blueprint
