...
class TestequipmentUIResourceConfig(RecordsUIResourceConfig):
    template_folder = "templates"
    url_prefix = "/testequipment"
    blueprint_name = "testequipment_ui"
    model_name = "testequipment"

    search_component = UIComponent(
        "TestequipmentResultsListItem",
        "@js/testequipment/search/ResultsListItem",
    ...
    application_id = "testequipment"


class TestequipmentUIResource(RecordsUIResource):
    pass

def ui_overrides(app):
    """Register UI overrides."""
    ui_resource_config = TestequipmentUIResourceConfig()
...
def init_menu(app):
    ...
    with app.app_context():
        current_menu.submenu("plus.create_testequipment").register(
...
def create_blueprint(app):
    ...
    blueprint = TestequipmentUIResource(TestequipmentUIResourceConfig()).as_blueprint()
    return blueprint
